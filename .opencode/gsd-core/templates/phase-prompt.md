...
<!-- For checkpoint task examples and patterns, see @C:/Projects/pet-platform/.opencode/gsd-core/references/checkpoints.md -->
...
See `C:/Projects/pet-platform/.opencode/gsd-core/references/tdd.md` for TDD plan structure.
...
See `C:/Projects/pet-platform/.opencode/gsd-core/templates/user-setup.md` for full schema and examples
...
See `C:/Projects/pet-platform/.opencode/gsd-core/workflows/verify-phase.md` for verification logic.
