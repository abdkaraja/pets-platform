...
<template>
@C:/Projects/pet-platform/.opencode/gsd-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@C:/Projects/pet-platform/.opencode/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `C:/Projects/pet-platform/.opencode/gsd-core/workflows/transition.md`.
...
- Follow @C:/Projects/pet-platform/.opencode/gsd-core/workflows/diagnose-issues.md
