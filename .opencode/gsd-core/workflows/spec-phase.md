...
ones). Reference: @C:/Projects/pet-platform/.opencode/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / C:/Projects/pet-platform/.opencode.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "C:/Projects/pet-platform/.opencode/gsd-core/bin/lib/edge-probe.cjs" \
  "C:/Projects/pet-platform/.opencode/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @C:/Projects/pet-platform/.opencode/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @C:/Projects/pet-platform/.opencode/gsd-core/templates/spec.md.
