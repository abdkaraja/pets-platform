...
```markdown
Read C:/Projects/pet-platform/.opencode/agents/gsd-ui-researcher.md for instructions.
...
Template: C:/Projects/pet-platform/.opencode/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read C:/Projects/pet-platform/.opencode/agents/gsd-ui-checker.md for instructions.
...
@C:/Projects/pet-platform/.opencode/gsd-core/references/ui-consideration-probe.md.
...
# (#448) — NOT the consuming project's git root — falling back to git toplevel / C:/Projects/pet-platform/.opencode.
...
UI_PROBE_JS=$(for _c in \
  ...
  "C:/Projects/pet-platform/.opencode/gsd-core/bin/lib/ui-consideration-probe.cjs" \
  "C:/Projects/pet-platform/.opencode/bin/lib/ui-consideration-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
