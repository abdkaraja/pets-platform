...
```
Agent(
  prompt="Read C:/Projects/pet-platform/.opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Projects/pet-platform/.opencode/gsd-core/templates/SECURITY.md`
