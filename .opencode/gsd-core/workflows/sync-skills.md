...
INSTALL_JS_GLOBAL="C:/Projects/pet-platform/.opencode/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node C:/Projects/pet-platform/.opencode/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
