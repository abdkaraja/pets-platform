...
<required_reading>
@C:/Projects/pet-platform/.opencode/gsd-core/references/ai-frameworks.md
@C:/Projects/pet-platform/.opencode/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read C:/Projects/pet-platform/.opencode/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "C:/Projects/pet-platform/.opencode/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read C:/Projects/pet-platform/.opencode/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read C:/Projects/pet-platform/.opencode/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read C:/Projects/pet-platform/.opencode/agents/gsd-eval-planner.md for instructions.
