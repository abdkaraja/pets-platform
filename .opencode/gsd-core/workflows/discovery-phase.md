...
See C:/Projects/pet-platform/.opencode/gsd-core/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using C:/Projects/pet-platform/.opencode/gsd-core/templates/discovery.md structure:
...
1. **Scope the discovery** using C:/Projects/pet-platform/.opencode/gsd-core/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from C:/Projects/pet-platform/.opencode/gsd-core/templates/discovery.md
...
Use C:/Projects/pet-platform/.opencode/gsd-core/templates/discovery.md.
