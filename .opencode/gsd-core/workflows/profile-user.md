...
Key references:
- @C:/Projects/pet-platform/.opencode/gsd-core/references/ui-brand.md (display patterns)
- @C:/Projects/pet-platform/.opencode/agents/gsd-user-profiler.md (profiler agent definition)
- @C:/Projects/pet-platform/.opencode/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="C:/Projects/pet-platform/.opencode/gsd-core/USER-PROFILE.md"
...
```bash
cp "C:/Projects/pet-platform/.opencode/gsd-core/USER-PROFILE.md" "C:/Projects/pet-platform/.opencode/USER-PROFILE.backup.md"
```
...
✓ Stores profile at C:/Projects/pet-platform/.opencode/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `C:/Projects/pet-platform/.opencode/gsd-core/references/user-profiling.md`
...
Reference: @C:/Projects/pet-platform/.opencode/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to C:/Projects/pet-platform/.opencode/gsd-core/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global AGENTS.md" -- "Add profile to C:/Projects/pet-platform/.opencode/AGENTS.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at C:/Projects/pet-platform/.opencode/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at C:/Projects/pet-platform/.opencode/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to C:/Projects/pet-platform/.opencode/AGENTS.md"
...
```bash
BACKUP_PATH="C:/Projects/pet-platform/.opencode/USER-PROFILE.backup.md"
```
...
Your profile:    C:/Projects/pet-platform/.opencode/gsd-core/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   C:/Projects/pet-platform/.opencode/skills/gsd-dev-preferences/SKILL.md
  ✓ AGENTS.md section       <resolved claude_md_path, default ./.opencode/AGENTS.md>
  ✓ Global AGENTS.md        C:/Projects/pet-platform/.opencode/AGENTS.md
```
