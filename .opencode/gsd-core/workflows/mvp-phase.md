...
<required_reading>
@C:/Projects/pet-platform/.opencode/gsd-core/references/user-story-template.md
@C:/Projects/pet-platform/.opencode/gsd-core/references/spidr-splitting.md
@C:/Projects/pet-platform/.opencode/gsd-core/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@C:/Projects/pet-platform/.opencode/gsd-core/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `question` calls. Each is free-text. After all three, assemble into the canonical sentence per `@C:/Projects/pet-platform/.opencode/gsd-core/references/user-story-template.md`:
...
Run the SPIDR rules from `@C:/Projects/pet-platform/.opencode/gsd-core/references/spidr-splitting.md`. Briefly:
