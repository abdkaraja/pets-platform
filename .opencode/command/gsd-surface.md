...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `C:/Projects/pet-platform/.opencode/.gsd-surface.json`
(sibling to `C:/Projects/pet-platform/.opencode/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `C:/Projects/pet-platform/.opencode/skills/gsd-*/`.
...
(`~/.config/opencode`), NOT the skills sub-directory (`C:/Projects/pet-platform/.opencode/skills`).
...
`C:/Projects/pet-platform/.opencode/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `C:/Projects/pet-platform/.opencode/.gsd-surface.json`).
...
<execution_context>
Surface state file: `C:/Projects/pet-platform/.opencode/.gsd-surface.json`
Install profile marker: `C:/Projects/pet-platform/.opencode/.gsd-profile`
Skill dirs: `C:/Projects/pet-platform/.opencode/skills/gsd-*/`
Engine module: `C:/Projects/pet-platform/.opencode/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `C:/Projects/pet-platform/.opencode/gsd-core/bin/lib/clusters.cjs`
</execution_context>
