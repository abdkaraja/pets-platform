...
<reference>
@C:/Projects/pet-platform/.opencode/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `C:/Projects/pet-platform/.opencode/gsd-core/references/user-profiling.md` to load:
