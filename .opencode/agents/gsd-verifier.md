...
<required_reading>
@C:/Projects/pet-platform/.opencode/gsd-core/references/verification-overrides.md
...
@C:/Projects/pet-platform/.opencode/gsd-core/references/thinking-models-verification.md

At verification decision points, reference calibration examples:
@C:/Projects/pet-platform/.opencode/gsd-core/references/few-shot-examples/verifier.md
...
**When the phase under verification has `mode: mvp` in ROADMAP.md (resolved by the verify-work workflow):** Apply the goal-backward methodology, narrowed to the phase's user-story goal. Required reading: `@C:/Projects/pet-platform/.opencode/gsd-core/references/verify-mvp-mode.md`.
