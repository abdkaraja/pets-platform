...
<required_reading>
@C:/Projects/pet-platform/.opencode/gsd-core/references/common-bug-patterns.md
</required_reading>
...
@C:/Projects/pet-platform/.opencode/gsd-core/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = C:/Projects/pet-platform/.opencode
                  → checks C:/Projects/pet-platform/.opencode/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = C:/Projects/pet-platform/.opencode/gsd-core
                  → writes to C:/Projects/pet-platform/.opencode/gsd-core/hooks/
...
@C:/Projects/pet-platform/.opencode/gsd-core/references/thinking-models-debug.md
...
- Read @C:/Projects/pet-platform/.opencode/gsd-core/references/common-bug-patterns.md
