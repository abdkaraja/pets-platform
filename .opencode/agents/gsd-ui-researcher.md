...
Use template from `C:/Projects/pet-platform/.opencode/gsd-core/templates/UI-SPEC.md`.
...
Read template: `C:/Projects/pet-platform/.opencode/gsd-core/templates/UI-SPEC.md`
