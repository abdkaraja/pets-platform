...
Reference full template: `C:/Projects/pet-platform/.opencode/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/Projects/pet-platform/.opencode/gsd-core/templates/state.md`.
